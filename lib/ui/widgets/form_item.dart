...
class _FormAddItemScreenState extends State<FormAddItem> {
    ...
    return Container(
      ...
      child:  TextFormField(
        ...
        validator: (val) {
          ...
          ? localizations.emptyItemNameError
          : null;
        },
  ...
  Widget _buildTextFieldSn() {
    ...
    return Container(
      ...
      child:  TextFormField(
        ...
        validator: (val) {
          return val.trim().isEmpty
          ? localizations.emptySerialError
          : null;
        },
  ...
  Widget _buildDropdownStatus() {
    List<String> _initStatus = <String>[
      'Working',
      'Maintenance',
      'Broken'
    ];
  ...
  Widget _buildDatePicker() {
    ...
    return Container(
      ...
      child:DateTimeField(
        ...
        initialValue: isEditing ? convertStringToDate(widget.item.dateCreation) : null, 
